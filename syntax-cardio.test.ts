...
describe("medium — sort titles without articles", () => {
  it("sorts as if The / A / An were stripped for comparison", () => {
    const input = ["The Matrix", "A Beautiful Mind", "Goodfellas", "An Education", "The Social Network"];
    ...
    expect(input).toEqual(["The Matrix", "A Beautiful Mind", "Goodfellas", "An Education", "The Social Network"]);
  });
});
